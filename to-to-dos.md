1) Make Remixer Primary for Spotify - Export with a duplicate version, one with a spotify version versions changed to the metadata
2) Take the EXISTING "Duplicate A Track Modal" and move it to a button at each track right near the "Copy Release Info Button" and call it "Copy Existing Track"
